...
/**
 * An {@link IPWMGenerator} implementation for the NXP PCA9685. The PCA9685 is an I²C-bus controlled 16-channel hardware
 * PWM generator.
 * 
 * @author Ralf Ellner - Initial contribution and API.
 *
 */
public class PCA9685PWMGenerator implements IPWMGenerator {
	...
	private class PCA9685PWMOutput implements IPWMOutput {
